...
function PropertyCards({ properties }) {
  ...
  const PropertyDetails = (event, id) => {
  ...
  return (
    <>
      {properties.map((property) => {
        return (
          <div onClick={(event) => PropertyDetails(event, property.id)} key={property.id} className="relative mx-auto w-full max-w-sm pt-6">
            <a
              href="/"
              ...
              <div className="rounded-lg">
                <div className="relative flex justify-center overflow-hidden rounded-lg">
                  <div className="w-full h-60 flex-shrink-0 overflow-hidden">
                    <img className="object-cover w-full h-full" src={property.filePath} alt="" />
                  </div>
                  ...
                  <div className="mt-4 grid grid-cols-2">
                    ...
                    <div className="flex items-center justify-end">
                      <p className="text-primary inline-block whitespace-nowrap rounded-xl font-semibold leading-tight">
                        ...
                        <span className="text-lg">{property.rentPerMonth}</span>/m
                      </p>
                    </div>
                  </div>
